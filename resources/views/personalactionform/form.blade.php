...
@section('content')
    <div class="container mt-5 mb-5">
        <div class="card m-auto border shadow p-3 rounded rounded-4" style="width: 80%">
            ...
            <div class="card-body px-5 mt-4">
                <form action="" class="needs-validation">
                    ...
                    <div class="row g-2 mb-4">
                        <div class="row g-2">
                            <div class="col-8">
                                <input type="text" class="form-control border border-dark shadow-sm"  id="employeeNumber" name="employeeNumber" required>
                            </div>
                            <div class="col-4">
                                <input type="date" class="form-control border border-dark shadow-sm" id="datePrepared" name="datePrepared">
                            </div>
                        </div>
                    </div>
                    <div class="row g-2">
                    ...
                    <div class="row g-2">
                        <div class="row g-2">
                            <div class="col-4">
                                <input type="text" class="form-control border border-dark shadow-sm" placeholder="Lastname" id="Lastname" name="lastname" required>
                            </div>
                            <div class="col-4">
                                <input type="text" class="form-control border border-dark shadow-sm" placeholder="Firstname" id="Firstname" name="firstname" required>
                            </div>
                            <div class="col-4">
                    ...
                    {{-- <div class="row g-3 mt-2">
                        ...
                        <div class="col-4">
                            <h6>Effective Date of Action</h6>
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-4">
                            <input type="text" class="form-control border border-dark shadow-sm" id="Department" name="department" required>
                        </div>
                        <div class="col-4">
                            <input type="text" class="form-control border border-dark shadow-sm"  id="Jobtitle" name="jobtitle" required>
                        </div>
                        <div class="col-4">
                            <input type="date" class="form-control border border-dark shadow-sm" id="dateInput" name="dateInput">
                        </div>
                    </div> --}}
