                ...
                <div class="card-body">
                    ...
                    <div class="row align-middle mt-3">
                        ...
                        <div class="col-4"><input type="text" class="form-control border-dark"
                                value="{{ $incidentReportForm->employee->last_name }} {{ $incidentReportForm->employee->first_name }}"
                                readonly /></div>
                        <div class="col-2 text-end align-self-center">DATE:</div>
                        <div class="col-4"><input type="date" name="report_date" class="form-control border-dark"
                                value="{{ $incidentReportForm->report_date }}"></div>
                    </div>
                    <div class="row align-middle mt-3">
                        <div class="col-2 text-end align-self-center">POSITION:</div>
                        <div class="col-4"><input type="text" class="form-control border-dark"
                                value="{{ $incidentReportForm->employee->position }}" readonly></div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="col-10 " colspan="3">
                                            <input type="text" class="form-control border-dark " name="location"
                                                value="{{ $incidentReportForm->incidentReportFormAnswer->location }}" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="col-2  text-end align-middle">
                                        ...
                                        <td class="col-4">
                                            <input type="date" class="form-control border-dark " name="incident_date"
                                                value="{{ $incidentReportForm->incidentReportFormAnswer->incident_date }}" />
                                        </td>
                                        ...
                                        <td class="col-4">
                                            <input type="text" class="form-control border-dark " name="incident_time"
                                                value="{{ $incidentReportForm->incidentReportFormAnswer->incident_time }}" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="col-10" colspan="3">
                                            <textarea class="form-control border-dark" name="incident_details" style="width: 100%; resize:none; height:200px">{{ $incidentReportForm->incidentReportFormAnswer->incident_details }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="col" colspan="2">
                                            <textarea class="form-control border-dark" name="cause" style="width: 100%; resize:none; height:200px">{{ $incidentReportForm->incidentReportFormAnswer->cause }}</textarea>
                                        </td>
                                        <td class="col" colspan="2">
                                            <textarea class="form-control border-dark" name="recommendation" style="width: 100%; resize:none; height:200px">{{ $incidentReportForm->incidentReportFormAnswer->recommendation }}</textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row mt-2 ">
                            ...
                            <div class="col">
                                <input type="text" name="reportedby" class="form-control border-dark"
                                    value="{{ $incidentReportForm->incidentReportFormAnswer->reportedby }}" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-7 py-2">
                            ...
                            <div class="col-5">
                                <input type="text" name="position" class="form-control border-dark"
                                    value="{{ $incidentReportForm->incidentReportFormAnswer->position }}" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-7 py-2">
                            ...
                            <div class="col-5">
                                <input type="text" name="department" class="form-control border-dark"
                                    value="{{ $incidentReportForm->incidentReportFormAnswer->department }}" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-7 py-2">
                            ...
                            <div class="col-5">
                                <input type="text" name="supervisor" class="form-control border-dark"
                                    value="{{ $incidentReportForm->incidentReportFormAnswer->supervisor }}" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-7 py-2">
                            ...
                            <div class="col-5">
                                <input type="text" name="employee_id" class="hidden"
                                    value="{{ $incidentReportForm->employee->id }}">
                            </div>
                        </div>
                    </div>
